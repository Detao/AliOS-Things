...
/*The total flash size is 128KB, 0x08000000~0x0807FFFF*/
void flash_partition_init(void)
{
    ...
    hal_partitions[HAL_PARTITION_APPLICATION].partition_length           = 0x75000; //108k bytes
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_1].partition_start_addr       = 0x08075000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_start_addr       = 0x08076000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_3].partition_start_addr       = 0x08078000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_4].partition_start_addr       = 0x08079000;
